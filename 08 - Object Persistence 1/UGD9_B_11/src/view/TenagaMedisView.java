...
public class TenagaMedisView extends javax.swing.JFrame {
    ...
    public void setComponent(boolean value) {
        ...
        dokterInput.setEnabled(value);
        perawatInput.setEnabled(value);
    ...
    private void initComponents() {
        ...
        dokterInput.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                dokterInputActionPerformed(evt);
            }
        });
        ...
        dokterPanelLayout.setHorizontalGroup(
            ...
            .addGroup(dokterPanelLayout.createSequentialGroup()
                ...
                .addGroup(dokterPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(dokterInput, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        dokterPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, dokterPanelLayout.createSequentialGroup()
                ...
                .addComponent(npaidiLabel)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(dokterInput, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );

        perawatInput.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                perawatInputActionPerformed(evt);
            }
        });
        ...
        perawatPanelLayout.setHorizontalGroup(
            ...
            .addGroup(perawatPanelLayout.createSequentialGroup()
                ...
                .addGroup(perawatPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(perawatInput, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        perawatPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, perawatPanelLayout.createSequentialGroup()
                ...
                .addComponent(nirappniLabel)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(perawatInput, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        try {
            ...
            if (tenagamedis == null) {
                ...
                dokterInput.setText(tenagamedis.getNpaidi());
                perawatInput.setText("" + tenagamedis.getPpni());
                if (dokterInput.getText().isEmpty()) {
...
//                    perawatRadioBtn.setSelected(false);
    ...
    private void dokterInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dokterInputActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_dokterInputActionPerformed

    private void perawatInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_perawatInputActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_perawatInputActionPerformed
        ...
        try {
            ...
            if (action.equals("Tambah")) {
                if (dokterRadioBtn.isSelected()) {
                    t = new TenagaMedis(idInput.getText(), namaInput.getText(), "Dokter", Integer.parseInt(tahunInput.getText()), noTeleponInput.getText(), dokterInput.getText(), 0);
                    tmControl.insertDataTenagaMedis(t);
                } else {
                    t = new TenagaMedis(idInput.getText(), namaInput.getText(), "Perawat", Integer.parseInt(tahunInput.getText()), noTeleponInput.getText(), "", Integer.parseInt(perawatInput.getText()));
                    tmControl.insertDataTenagaMedis(t);
                }
                JOptionPane.showMessageDialog(null, "Berhasil Tambah Data!");
            } else {
                if (jenis.contains("Dokter")){
                    t = new TenagaMedis(idInput.getText(), namaInput.getText(), "Dokter", Integer.parseInt(tahunInput.getText()), noTeleponInput.getText(), dokterInput.getText(), 0);
    ...
    private javax.swing.JTextField dokterInput;
    ...
    private javax.swing.JTextField perawatInput;
