...
public class Platinum extends PaketSewaMobil implements IPendapatan, IDurasi {
    ...
    public Platinum(String nomorTransaksi, String jenisMobil, double jarak, double tarifBensin, String waktuBerangkat, String waktuKembali, double tarifDriver, double tarifFullService) {
