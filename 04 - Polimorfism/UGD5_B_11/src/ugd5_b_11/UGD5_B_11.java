...
public class UGD5_B_11 {
    ...
    public static void main(String[] args) throws IOException {
        String nomorTransaksi, jenisMobil;
        double jarak, tarifBensin, tarifKebersihan, tarifMaintenance, tarifLepasKunci, tarifKonsumsi;
        int menu, count, i;
            ...
            switch (menu) {
                case 1 :
                    ...
                    for (i = 0; i < count; i++) { 
                        ...
                        pktSewa.add(new Silver(nomorTransaksi, jenisMobil, jarak, tarifBensin, tarifKebersihan, tarifMaintenance));
                    }
                    break;
                ...
                case 2 :
                    ...
                    for (i = 0; i < count; i++) { 
                        ...
                        pktSewa.add(new Gold(nomorTransaksi, jenisMobil, jarak, tarifBensin, tarifLepasKunci, tarifKonsumsi));
                    }
                    break;
